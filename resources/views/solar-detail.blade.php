        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <div class="page-titles whitecolor text-center padding_top padding_bottom">
                    ...
                    <h2 class="font-xlight"><br></h2>
                    <h2 class="font-bold">Solar Services</h2>
        ...
        <div class="row whitebox top15">
            ...
            <div class="col-lg-8 col-md-7">
                <div class="widget heading_space_half text-center text-md-left">
                    ...
                    <p class="bottom30 dark">Solar energy can be used as an alternative to the electricity. Utilization
                        of
                        the solar energy for various purposes could divide the burden on the electricity production.
                        Installation of solar panels as an alternative to electricity lines may reduce the load on
                        electricity by as much as 50% and similarly so as the cost of electricity consumption. </p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 mt-5 mt-md-0">
                        <div class="image widget heading_space_half"><img alt="SEO" src="images/solar4.jpg"></div>
