        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <div class="page-titles whitecolor text-center padding_top padding_bottom">
                    ...
                    <h2 class="font-bold">Asset Management</h2>
                    <h2 class="font-xlight"><br></h2>
        ...
        <div class="bg-blue title-wrap bottom25">
            <div class="row">
                <div class="col-lg-12 col-md-12 whitecolor">
                    <h3 class="float-left">Asset Management Detail</h3>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="news_item shadow-equal">
                    ...
                    <div class="news_desc text-center text-md-left">
                        <h3 class="text-capitalize font-normal darkcolor"><a href="#.">Asset Management</a>
                        </h3>
                        <p class=" top10">Lead development, maintenance, implementation, and tracking of IPS-Energy US
                            Asset management policies, strategies, objectives, and plans.

                            Communicates with industrial and professional organizations to develop and improve
                            appropriate material standards, processes, safety, and reliability standards for electrical
                            assets. Was Responsible for ENMAX/ATCO/IPS Energy USA asset life cycle activities, including
                            defining of maintenance practices/processes for asset classes and further defining criteria
                            and process utilized to determine when an asset is replaced or refurbished.</p>
