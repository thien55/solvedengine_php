...
@section('content')
<section id="main-banner-page" class="position-relative page-header service-detail-header section-nav-smooth parallax" style="background-image: url('images/security1.jpg');">
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <div class="page-titles whitecolor text-center padding_top padding_bottom">
                    ...
                    <h2 class="font-xlight"><br></h2>
                    <h2 class="font-bold">Security Services</h2>
        ...
        <div class="bg-blue title-wrap">
            <div class="row">
                <div class="col-lg-12 col-md-12 whitecolor">
                    <h3 class="float-left">Security & Survillence</h3>
    ...
    <div class="container">
        <div class="row whitebox top15">
            <div class="col-lg-4 col-md-5">
                <div class="image widget heading_space_half"><img alt="SEO" src="images/security/3.jpg"></div>
            ...
            <div class="col-lg-8 col-md-7">
                <div class="widget heading_space_half text-center text-md-left">
                    <h3 class="darkcolor font-normal bottom30">Security & Survillence</h3>

                    <p class="bottom30 dark">Security is a necessity for every citizen. With the growing crime rate in
                        the
                        world, the need for security services and surveillance is also increasing steadily. We have a
                        solution to keep you safe and secure as we are providing the most effective security and
                        surveillance services in the country. </p>

                    {{-- <p class="bottom30 dark">We are here to help you cut your bill in half by providing best services
                        solar
                        related products.</p> --}}
                ...
                <div class="row">
                        ...
                        <div id="accordion">
                            <form class="getin_form wow fadeInUp" data-wow-delay="400ms">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <button type="submit" class="button btn btn-alt w-100 btn button btn-blue transition-3 " id="submit_btn1">Free Consultation</button>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="col-lg-6 col-md-6 mt-5 mt-md-0">
                        <div class="image widget heading_space_half"><img alt="SEO" src="images/security/2.jpg"></div>
