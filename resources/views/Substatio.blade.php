        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <div class="page-titles whitecolor text-center padding_top padding_bottom">
                    ...
                    <h2 class="font-bold">Substation – Minor Projects</h2>
                    <h2 class="font-xlight"><br></h2>
        ...
        <div class="bg-blue title-wrap bottom25">
            <div class="row">
                <div class="col-lg-12 col-md-12 whitecolor">
                    <h3 class="float-left">Substation – Minor Projects Detail</h3>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="news_item shadow-equal">
                    ...
                    <div class="news_desc text-center text-md-left">
                        <h3 class="text-capitalize font-normal darkcolor"><a href="#.">Substation – Minor Projects</a>
                        </h3>
                        <p class=" top10">Fiesta City Substation – 115-12.5 kV New Transformer Bay & Feeder Addition
                            Minnesota Valley Substation – 115 kV Replace Line Relaying PLC to Fiber Lyon County
                            Substation – 115 kV Solar Farm Interconnection to Ring Bus.</p>
