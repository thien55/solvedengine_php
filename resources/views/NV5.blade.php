        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <div class="page-titles whitecolor text-center padding_top padding_bottom">
                    ...
                    <h2 class="font-bold">NV5_SoCalGas_SDGE</h2>
                    <h2 class="font-xlight"><br></h2>
        ...
        <div class="bg-blue title-wrap bottom25">
            <div class="row">
                <div class="col-lg-12 col-md-12 whitecolor">
                    <h3 class="float-left">NV5_SoCalGas_SDGE Detail</h3>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="news_item shadow-equal">
                    ...
                    <div class="news_desc text-center text-md-left">
                        <h3 class="text-capitalize font-normal darkcolor"><a href="#.">NV5_SoCalGas_SDGE</a>
                        </h3>
                        <p class=" top10">Provided Drafting support using CAD software and Civil Engineering 3D software
                            to support multiple subcontract projects in the SoCal Gas and SDGE service areas in Southern
                            California.</p>
