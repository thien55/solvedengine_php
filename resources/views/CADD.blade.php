        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <div class="page-titles whitecolor text-center padding_top padding_bottom">
                    ...
                    <h2 class="font-bold">PLS-CADD modeling for Structural and clearance analysis</h2>
                    <h2 class="font-xlight"><br></h2>
        ...
        <div class="bg-blue title-wrap bottom25">
            <div class="row">
                <div class="col-lg-12 col-md-12 whitecolor">
                    <h3 class="float-left">PLS-CADD modeling for Structural and clearance analysis Detail</h3>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="news_item shadow-equal">
                    ...
                    <div class="news_desc text-center text-md-left">
                        <h3 class="text-capitalize font-normal darkcolor"><a href="#.">PLS-CADD modeling for Structural
                                and clearance analysis</a>
                        </h3>
                        <p class=" top10">PLS-CADD modeling for Structural and clearance analysis was performed on
                            following circuits <br>

                            • C157 12kV Distribution <br>
                            • C908 12kV Distribution <br>
                            • C971 12kV Distribution <br>
                            • C1030 12kV Distribution <br>
                            • C445 12kV Distribution.</p>
