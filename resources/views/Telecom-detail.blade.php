...
@section('content')
<section id="main-banner-page" class="position-relative page-header service-detail-header section-nav-smooth parallax" style="background-image: url('images/telecom/1.jpg');">
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <div class="page-titles whitecolor text-center padding_top padding_bottom">
                    ...
                    <h2 class="font-xlight"><br></h2>
                    <h2 class="font-bold">Telecom Services</h2>
        ...
        <div class="bg-blue title-wrap">
            <div class="row">
                <div class="col-lg-12 col-md-12 whitecolor">
                    <h3 class="float-left">Telecom</h3>
    ...
    <div class="container">
        <div class="row whitebox top15">
            <div class="col-lg-4 col-md-5">
                <div class="image widget heading_space_half"><img alt="SEO" src="images/telecom/2.jpg"></div>
            ...
            <div class="col-lg-8 col-md-7">
                <div class="widget heading_space_half text-center text-md-left">
                    <h3 class="darkcolor font-normal bottom30">Telecom Services</h3>
                    <p class="bottom30 dark">Modern day communication is all wireless. Hustles of having cables for
                        telephones is no more a story now. We are here to provide you most convenient and affordable
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 mt-5 mt-md-0">
                        <div class="image widget heading_space_half"><img alt="SEO" src="images/telecom/3.jpg"></div>
