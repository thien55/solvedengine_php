        ...
        <div class="bg-blue title-wrap bottom25">
            <div class="row">
                <div class="col-lg-12 col-md-12 whitecolor">
                    <h3 class="float-left">Transmission Detail</h3>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="news_item shadow-equal">
                    ...
                    <div class="news_desc text-center text-md-left">
                        <h3 class="text-capitalize font-normal darkcolor"><a href="#.">Transmission</a>
                        </h3>
                        <p class=" top10">Arco Plant Underground Transmission Line – 230 kV HPOF Cable Assessment <br>

                            Advised on state of underground HPOF cables and feasibility on additional load on existing
                            <br>
                            system Suncrest Underground Transmission Line – 230 kV Double Circuit XLPE Cable
                            Installation <br>
                            FEA ampacity calculation/simulation and overall routing design Hiawatha West-Midtown
                            Underground Transmission Line – 115 kV Double Circuit XLPE Cable Installation <br>
                            FEA ampacity calculation/simulation for operations facility ratings
                        </p>
